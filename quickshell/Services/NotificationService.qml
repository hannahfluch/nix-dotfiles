...
QtObject {
    ...
    // Amount of missed notifications while on silent-mode
    ...
    property string historyFile: Settings.cacheDir + "notifications.json"
    ...
    function removeAllNotifications() {
        for (var i = 0; i < notificationModel.count; i++) {
            animateAndRemove(notificationModel.get(i), i);
        }
    }
