...
PanelWindow {
  ...
  property bool showOverlay: Settings.general.dimDesktop
  property int topMargin: Settings.bar.top ? Style.barHeight * scaling : 0
  property int bottomMargin: !Settings.bar.top ? Style.barHeight * scaling : 0
